...
const FloatingShape: React.FC<FloatingShapeProps> = ({
  ...
  return (
    ...
    >
      <path d={blobPath} fill={color} opacity={0.4} />
    </svg>
  );
};
...
export default function Home() {
    ...
    const newShapes = Array.from({ length: 12 }, (_, i) => {
      ...
      return {
        ...
        position: {
          x:
            window.innerWidth / 2 +
            ((Math.random() * window.innerWidth) / 6) *
              (Math.random() > 0.5 ? 1 : -1),
          y:
  ...
  return (
    <main className="bg-[#141414] flex min-h-screen flex-col items-center justify-between">
      <div id="home" className="bg-[#141414] w-full h-screen">
        {" "}
        ...
        <div className="text-white text-center h-screen w-screen flex flex-col items-center justify-center mb-20 sm:mb-40">
          ...
          <h1 className="mx-auto text-5xl pl-4 pr-4 text-center sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl ps-4">
            HI, I&apos;M RAGHAV
          </h1>
          <h1 id="rotating-title" className="mx-auto text-4xl pt-20">
            COMPUTER ENGINEER
          </h1>
          <h1
            id="rotating-title"
            className="mx-auto text-4xl text-gray-500 pt-2"
          >
            @ {"UIUC"}
          </h1>
        </div>
        ...
        <div id="home" className="fixed top-0 w-full px-4 pt-4 z-50 ">
          <nav className="mx-auto max-w-6xl bg-[#1a1a1a]/20 backdrop-blur-md rounded-full border border-[#1b1b1b]/100">
            <div className="px-6 lg:px-8">
              <div className="grid grid-cols-3 items-center h-14 relative">
                {" "}
                {/* Added relative here too */}
                <div className="w-[104px] hidden lg:block bg-[#1a1a1a]/20"></div>
                <div className="flex items-center justify-center space-x-8 lg:flex hidden">
                  {" "}
                  {/* Hide on mobile */}
                  <button
                ...
                <div className="flex items-center justify-end space-x-6">
                  <div className="lg:flex hidden space-x-6">
                    ...
                    {/* Hide on mobile */}
                    <a
                      href="https://x.com/raghav_tiru"
                      className="text-white hover:text-gray-300 transition-colors duration-200"
                    >
                      <XLogo size={32} />
                    </a>
                    <a
                      href="https://www.linkedin.com/in/raghavtirumale/"
                      className="text-white hover:text-gray-300 transition-colors duration-200"
                    >
                      <LinkedinLogo size={32} />
                    </a>
                    <a
                      href="https://github.com/MythicalCow"
                      className="text-white hover:text-gray-300 transition-colors duration-200"
                    >
                      <GithubLogo size={32} />
                    </a>
                  ...
                  <button
                    ...
                    className="lg:hidden text-white absolute right-0"
                  >
                    {" "}
                    {/* Mobile menu button */}
                    <List size={32} />
                ...
                {/* Mobile Menu */}
                {isMobileMenuOpen && (
                  <div className="absolute top-full right-0 bg-[#1a1a1a]/20 backdrop-blur-md rounded-b-lg border-b border-[#1b1b1b]/100 py-4 w-full lg:hidden z-10 pr-2">
                    {" "}
                    {/* Adjusted top to 14 */}
      ...
      <div className="h-screen w-screen flex items-center justify-center">
        <section
          id="about"
          className="bg-[#1a1a1a]/20 backdrop-blur-md rounded-2xl px-8 py-16 mx-auto mt-16 max-w-4xl"
        >
          ...
          <div className="text-2xl text-gray-400 leading-relaxed">
            <p className="mb-6">
              Currently building systems to detect and disrupt unmanned aerial
              systems at Guardian RF (YC S24).
            </p>
            <p className="mb-6">
              Worked at Khoj AI (YC S23) to build an open-source AI assistant
              that currently has 17k+ stars on GitHub.
            </p>
            <p className="mb-6">
              Worked as an embedded software lead at Illinois Electric
              Motorsports, a premier college FSAE team.
            </p>
            <p className="mb-6">Computer Engineering @ UIUC</p>
            <p className="mb-6">
      ...
      <div className="h-screen w-screen flex items-center justify-center">
        ...
        >
          ...
          <div className="text-2xl text-gray-400 leading-relaxed">
            <p className="mb-6">
              I love talking with people building cool things. Email me at{" "}
              <a
                href="mailto:raghavt3@illinois.edu"
                className="text-blue-400 hover:underline"
              >
                raghavt3@illinois.edu
              </a>
            </p>
          </div>
        </section>
